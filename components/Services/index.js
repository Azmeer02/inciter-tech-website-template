...
const Services = () => {
  return (
    <div className="services_container">
      ...
      <div className="services_card_container_upper">
        <Card style={{ width: 400 }}>
          <div className="services_card_icon_container">
            <span class="services_card_icon_background"></span>
            <MobileOutlined />
          </div>
          <div className="services_card_heading">
            <p>Mobile App Development</p>
          </div>
          <div className="services_card_paragraph">
      ...
      <div className="services_card_container_lower">
        <Card style={{ width: 400 }}>
          <div className="services_card_icon_container">
            <span class="services_card_icon_background"></span>
            <CloudOutlined />
